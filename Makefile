...
EXEC = main init init2 render raycasting moves player walls draw colors minimap teleport particles positions clean
PARS = parsing utils check free map scam valid texture
